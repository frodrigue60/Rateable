                    ...
                    <div class="mb-3">
                        <form action="{{ route('upload.profile.pic') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="profile-file" name="image" accept=".jpg, .jpeg, .png, .webp" required>
                            </div>
                    ...
                    <div class="mb-3">
                        <form action="{{ route('upload.banner.pic') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" id="banner-file" name="banner" accept=".jpg, .jpeg, .png, .webp" required>
                            </div>
                            <div class="row d-flex">
                                <button class="btn btn-primary" type="submit" id="inputGroupFileAddon04">Save</button>
                            </div>
