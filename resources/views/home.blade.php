            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <div>
                            <form action="{{ route('scoremethod') }}" method="POST" enctype="multipart/form-data">
                                @method('post')
                                @csrf
                                <div class="input-group">
                                    <select name="scoremethod" class="form-select" id="inputGroupSelect04"
                                        aria-label="Example select with button addon">
                                        <option value="null" selected>Scoring System</option>
                                        <option value="100">100 Point (55/100)</option>
                                        <option value="10decimal">10 Point Decimal (5.5/10)</option>
                                        <option value="10integer">10 Point (5/10)</option>
                                        <option value="5star">5 Star (3/5)</option>
                                    </select>
