        ...
        <div>
            <form id="commnent-form" action="" method="post" class="d-flex flex-column gap-2">
                ...
                <div class="form-floating">
                    <textarea id="comment-content" name="content" class="form-control" placeholder="Write us your comment" id="floatingTextarea" required></textarea>
                    <label for="floatingTextarea">Write us your comment</label>
                </div>
